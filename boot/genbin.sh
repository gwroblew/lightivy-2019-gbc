...
$OBJCOPY --only-section .iram2.text -O binary $TARGETELF $BUILDDIR/iram2.bin
...
echo -n -e "\xE9\x03\x00\x4f" >  $FWFILE
write_addr " main$"

echo Writing iram2 section...
write_addr " _iram2_text_start$"
write_section $BUILDDIR/iram2.bin
...
write_checksum $BUILDDIR/iram2.bin $BUILDDIR/text.bin $BUILDDIR/rodata.bin
