...
uint8_t tms_lookup[16][256][2];   /* Expand BD, PG data into 8-bit pixels (G1,G2) */
uint8_t mc_lookup[16][256][8];    /* Expand BD, PG data into 8-bit pixels (MC) */
uint8_t txt_lookup[256][2];       /* Expand BD, PG data into 8-bit pixels (TX) */
uint8_t bp_expand[256][8];        /* Expand PG data into 8-bit pixels */
uint8_t tms_obj_lut[16*256];      /* Look up priority between SG and display pixels */
